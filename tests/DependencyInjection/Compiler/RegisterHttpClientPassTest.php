...
final class RegisterHttpClientPassTest extends AbstractCompilerPassTestCase
{
    ...
    {
        $this->setParameter('setono_post_nord.http_client', 'http_client_service_id');
        $this->setDefinition('http_client_service_id', new Definition());

        $this->compile();

        $this->assertContainerBuilderHasAlias('setono_post_nord.http_client', 'http_client_service_id');
    }
    ...
    public function if_buzz_http_client_service_exists_the_service_alias_exists(): void
    {
        ...
        $this->assertContainerBuilderHasAlias('setono_post_nord.http_client', 'Buzz\Client\BuzzClientInterface');
    }
}
